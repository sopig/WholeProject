...
@implementation UIView (NT_BUIView) 
                                         ...
                                         onCancel:(YSCancelBlock)cancelled
{
    ...
    {
        [self photoPickerWithSourceType:[[types objectAtIndex:0] intValue] presentVC:presentVC onPhontePicked:photoPicked onCancel:cancelled];
    }
    else
    {
        ...
        [actionSheet showInView:presentVC.view withCompletionHandler:^(NSInteger buttonIndex) {
            if (buttonIndex < types.count) {
                [self photoPickerWithSourceType:[[types objectAtIndex:buttonIndex] intValue] presentVC:presentVC onPhontePicked:photoPicked onCancel:cancelled];
            }
        }];
    }
}
